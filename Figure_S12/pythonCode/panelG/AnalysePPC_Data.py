...
def main():
    mat = scipy.io.loadmat('PPC_python.mat')
    R_all = mat['R_all']
    S_all = mat['S_all']
    ...
    df.to_csv('resultsPPC_shuffCorr.csv', index=False)
'''
    with open('resultsPPC_unbiased.pkl', 'rb') as file:
    ...
    plt.tight_layout()
    plt.savefig('RealData_results/PPC_unbiased.svg', format='svg', bbox_inches='tight')
    plt.savefig('RealData_results/PPC_unbiased.png', format='png', bbox_inches='tight')
'''
