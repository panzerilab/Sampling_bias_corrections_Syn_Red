...
def main():
     mat = scipy.io.loadmat('CA1_python.mat')
     R_all = mat['R_all']
     S_all = mat['S_all']
     ...
     df.to_csv('resultsCA1_shuffCorr.csv', index=False)
     ...
     # plt.tight_layout()
     # plt.savefig('RealData_results/Hippocampus_Results_unbiased.svg', format='svg', bbox_inches='tight')
     # plt.close()
