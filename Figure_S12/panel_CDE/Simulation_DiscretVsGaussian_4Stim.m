...
for a=1:length(alphasweep)
    ...
    parfor b=1:length(Bsweep)
        ...
        rate1 = B + alpha*beta*[1,0,1,0] + alpha*(1-beta)*[1,1,0,0];
        rate2 = B + alpha*beta*[1,1,0,0] + alpha*(1-beta)*[1,0,1,0];
        X1_tmp=[];
        X2_tmp=[];
        Y = [];
...
save('Discrete/SimulationR1/R1A_B/I_gt_4Stim.mat', "I_gt" );
save('Discrete/SimulationR1/R1A_B/data_4Stim.mat', 'X1', 'X2', 'Y', 'Bsweep', 'alphasweep');
%% Analysis Simulation
load('data_4stim.mat');
opts_MI.bias='plugin';
...
save('Discrete/SimulationR1/R1A_B/I_discrete_4S.mat', 'I_discrete');
%% Plot
clc, clear, close all
...
% Plot
load('Discrete/SimulationR1/R1A_B/I_discrete_4S.mat', 'I_discrete');
info_venk = load('info_Gpid_4Stim.mat');
load('I_gt_4Stim.mat');
load('data_4Stim.mat');
...
saveas(figure_handle, 'Combined_Info_Map_4Stim.svg');
