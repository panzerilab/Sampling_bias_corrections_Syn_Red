...
% Export
% exportgraphics(fig_corr,'PID_Bias_AllCorrections.pdf','ContentType','vector');
exportgraphics(fig_raw,'PID_Bias_All.png','Resolution',600);
set(fig_raw,'Renderer','painters');
print(fig_raw,'-dsvg','PID_Bias_All');
